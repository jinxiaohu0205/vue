...
;(function(root, factory) {
    ...
    jedfn.init = function(){
        var that = this, opts = that.opts, newDate = new Date(),
            ...
            zIndex = opts.zIndex == undefined ? 999999 : opts.zIndex,
    ...
    jedfn.chooseDays = function(opts,boxCell) {
        ...
        if(opts.festival && lang.name == "cn") {
            ...
            boxCell.find(".jedaul li").on("mouseover", function () {
                ...
                tipDiv.css({"z-index":  (opts.zIndex == undefined ? 999999 + 5 : opts.zIndex + 5),top:tipPos.top,left:tipPos.left,position:"absolute",display:"block"});
